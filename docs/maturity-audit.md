...
2. Prove Cloudflare Static recovery with a live timeout/recovery canary, then design provider-aware activation for recovered Cloudflare-backed deployments without using metadata-only `promote-deployment`.
