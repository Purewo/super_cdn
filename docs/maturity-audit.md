...
2. Continue with hybrid-edge writeback or full Cloudflare-backed rollback only when Worker/KV/domain writes are coupled to strict live probes and audit events.
