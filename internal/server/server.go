...
func (s *Server) routes() {
	...
	s.apiMux.HandleFunc("GET /quota", s.handleGetQuota)
	s.apiMux.HandleFunc("POST /quota/requests", s.handleCreateQuotaRequest)
	s.apiMux.HandleFunc("GET /quota/requests", s.handleListQuotaRequests)
	s.apiMux.HandleFunc("POST /quota/requests/{id}/approve", s.handleApproveQuotaRequest)
	s.apiMux.HandleFunc("POST /quota/requests/{id}/reject", s.handleRejectQuotaRequest)
	s.apiMux.HandleFunc("POST /quota/users/{id}", s.handleSetUserQuota)
